...
#     {"LOB": "TW", "SEGMENT": "TW TP",  "PO": "-3%", "REMARKS": "Payin Above 30%"},
#     {"LOB": "TW", "SEGMENT": "TW TP",  "PO": "-3%", "REMARKS": "Payin Above 40%"},
...
# Note: If the PO is decline , then please  just consider it as 0%
# also note that if in rto or location if STATE Name as well as City name is mentioned then please consider it as it is , please , don't overwrite it as state name 
# because in one column state name is given and in one column city name is given for example
# Maharashtra | Mumbai
# and below these column, PO are given so please consider location for one as Maharashtra and Mumbai for another 
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "https://icici-image-report.vercel.app"
    ],
    allow_credentials=True,
    allow_methods=["*"],
    allow_headers=["*"],
...
One more example I am giving you : 
For example this is the Table , okay ??
I am giving you this for example , actually it is not the real data , or the data can be differnet , but I am giving you the possibility of the data
Product Segment,PCV 3W,GCV >2450T TO 3500 T GVW,GCV >2450T TO 3500 T GVW,GCV >2450T TO 3500 T GVW,New TW
Usage,Auto Rickshaw,Market Load,Market Load,Market Load,TW
Fuel,CNG/LPG/Petrol,CNG/LPG/Petrol,CNG/LPG/Petrol,CNG/LPG/Petrol,EV
Make,All,Ashok,MM,TATA,Kinetic / Egauss
Age (in years),1-10 Years,>3,4-10,Old,New
Business Type,Renewal / Rollover / Used,Renewal / Rollover / Used,Renewal / Rollover / Used,Renewal / Rollover / Used,New
LOB,Comp / AOTP,Comp / AOTP,Comp / AOTP,Comp / AOTP,Comp
RTO Cluster,Pune,Pune,Pune,Pune,Karad / Satara
RTO Code,"MH12 , MH14","MH12 , MH14","MH12 , MH14","MH12 , MH14",New
PO%,74%,57%,50%,50%,57%
Effective From,1st Oct’25,1st Oct’25,1st Oct’25,1st Oct’25,1st Oct’25
TO,31st Oct’25,31st Oct’25,31st Oct’25,31st Oct’25,31st Oct’25


ok , so the row of starting , means the first row consider as key and rest in the same row as value , please consider it 

Also sometimes the rates are given in one column given the range , dont get confused ,please compute it
Return ONLY JSON array, no markdown.
